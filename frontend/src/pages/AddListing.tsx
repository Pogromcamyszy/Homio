...
export default function AddListing() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!district) {
      alert("Kliknij pin na mapie w granicach Krakowa, aby wybrać dzielnicę.");
      return;
    }
      ...
      <form onSubmit={handleSubmit}>
        ...
        {!district && !pinMoved && (
          <p className="district-hint">
            Kliknij na mapie, żeby automatycznie wykryć dzielnicę.
          </p>
        )}
        {!district && pinMoved && (
          <p className="district-error">
            Lokalizacja poza granicami Krakowa — przesuń pin.
          </p>
        )}
        ...
        {/* MAPA — nad przyciskiem */}
        <p className="map-hint">
          Kliknij na mapie, żeby ustawić lokalizację ogłoszenia.
        </p>
